...
var index = require('./lib/eventemitter3@5.0.1/lib/eventemitter3/index.cjs');
...
var v4 = require('./lib/uuid@10.0.0/lib/uuid/dist/esm-browser/v4.cjs');
