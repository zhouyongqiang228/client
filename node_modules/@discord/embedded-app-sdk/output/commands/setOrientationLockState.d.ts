...
export declare const setOrientationLockState: (sendCommand: TSendCommand) => (args: SetOrientationLockStateInput) => Promise<zod.TypeOf<zod.ZodNullable<zod.ZodObject<{}, "strip", zod.ZodTypeAny, {}, {}>>>>;
