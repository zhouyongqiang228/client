 ...
 */
export declare const openInviteDialog: (sendCommand: TSendCommand) => (args: void) => Promise<import("zod").TypeOf<import("zod").ZodNullable<import("zod").ZodObject<{}, "strip", import("zod").ZodTypeAny, {}, {}>>>>;
