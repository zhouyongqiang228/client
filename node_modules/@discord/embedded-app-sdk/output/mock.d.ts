...
export declare class DiscordSDKMock implements IDiscordSDK {
    ...
    _updateCommandMocks(newCommands: Partial<IDiscordSDK['commands']>): {
        ...
        authorize: (args: import("./commands/authorize").AuthorizeInput) => Promise<zod.TypeOf<zod.ZodObject<{
            code: zod.ZodString;
        ...
        captureLog: (args: import("./commands/captureLog").CaptureLogInput) => Promise<zod.TypeOf<zod.ZodNullable<zod.ZodObject<{}, "strip", zod.ZodTypeAny, {}, {}>>>>;
        encourageHardwareAcceleration: (args: void) => Promise<zod.TypeOf<zod.ZodObject<{
        ...
        getChannel: (args: import("./commands/getChannel").GetChannelInput) => Promise<zod.TypeOf<zod.ZodObject<{
            id: zod.ZodString;
        ...
        getChannelPermissions: (args: void) => Promise<zod.TypeOf<zod.ZodObject<{
        ...
        getEntitlements: (args: void) => Promise<zod.TypeOf<zod.ZodObject<{
        ...
        getPlatformBehaviors: (args: void) => Promise<zod.TypeOf<zod.ZodObject<{
        ...
        getSkus: (args: void) => Promise<zod.TypeOf<zod.ZodObject<{
        ...
        openExternalLink: (args: import("./commands/openExternalLink").OpenExternalLinkInput) => Promise<zod.TypeOf<zod.ZodNullable<zod.ZodObject<{}, "strip", zod.ZodTypeAny, {}, {}>>>>;
        openInviteDialog: (args: void) => Promise<zod.TypeOf<zod.ZodNullable<zod.ZodObject<{}, "strip", zod.ZodTypeAny, {}, {}>>>>;
        openShareMomentDialog: (args: {
            mediaUrl: string;
        }) => Promise<{} | null | undefined>;
        setActivity: (args: import("./commands/setActivity").SetActivityInput) => Promise<zod.TypeOf<zod.ZodObject<{
            name: zod.ZodString;
            type: zod.ZodNumber;
            url: zod.ZodNullable<zod.ZodOptional<zod.ZodString>>;
        ...
        setConfig: (args: import("./commands/setConfig").SetConfigInput) => Promise<zod.TypeOf<zod.ZodObject<{
        ...
        setOrientationLockState: (args: import("./commands/setOrientationLockState").SetOrientationLockStateInput) => Promise<zod.TypeOf<zod.ZodNullable<zod.ZodObject<{}, "strip", zod.ZodTypeAny, {}, {}>>>>;
        startPurchase: (args: import("./commands/startPurchase").StartPurchaseInput) => Promise<zod.TypeOf<zod.ZodNullable<zod.ZodArray<zod.ZodObject<{
            id: zod.ZodString;
            sku_id: zod.ZodString;
            application_id: zod.ZodString;
            user_id: zod.ZodString;
        ...
        userSettingsGetLocale: (args: void) => Promise<zod.TypeOf<zod.ZodObject<{
